...
template <>
inline void Drawing::blit<Shapes::Rectangle>(SDL_Renderer *renderer,
                                             const SDL_FRect *srcRect) noexcept
{
...
template <>
inline void Drawing::blit<Shapes::Triangle>(SDL_Renderer *renderer,
                                            const SDL_FRect *srcRect) noexcept
{
